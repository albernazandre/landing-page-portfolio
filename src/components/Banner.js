        ...
        <div className='flex flex-col gap-y-8 lg:flex-row lg:items-center
          ...
          lg:text-left'>
            <motion.h1
              ...
              className='text-[55px] font-bold leadding-[0.8]
              lg:text-[70px] mb-8'
            >
              MINEIRO <span>INVEST</span>
            </motion.h1>
            <motion.div 
            ...
            <motion.p
              ...
              mx-auto lg:mx-0'>
              Conheça nossos cursos, artigos e muito mais!
            </motion.p>
            <motion.div
          ...
          <motion.div
            ...
            initial="hidden" 
            whileInView={'show'}
            className='lg:flex flex-1 max-w-[320px]
            lg:max-w-[482px]'>
